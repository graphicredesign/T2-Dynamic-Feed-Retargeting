...
temple.Banner = function(_super) {
    ...
    banner.prototype.setupDynamic = function() {
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Template = "small";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Asset_Type = "Video";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Asset.Progressive_Url = "img/elantra.mp4";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Endframe_Image.Url = "https://s0.2mdn.net/ads/richmedia/studio/33345/33345_20170713164124541_video_end_frame.jpg";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Overlay_Text = "Options shown.";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_1.Url = "https://s0.2mdn.net/ads/richmedia/studio/20680911/20680911_20170804104224313_300x50_sonata_1.jpg";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_2.Url = "";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_3.Url = "";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_4.Url = "";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_1 = "Sonata";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_2 = "";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_3 = "";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_4 = "";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Multi_Copy_Delay = "1,1,1,1";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Offer_Copy_1 = "Owners receive up to";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Offer_Copy_2 = "$1,750";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Offer_Copy_3 = "Cash Back";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Offer_Copy_4 = "for 36 months with $2,499 due<br> at lease signing. $0 security<br> deposit. Excludes tax title and<br> license.";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Endframe_Animation_Style = "fade";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].CTA_Button_At_Start_Toggle = false;
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Legal_Container_Text = "Optional features shown. Service Valet available from Authorized Genesis Retailers during complimentary maintenance period. Includes normal wear, parts replacement and warranty repairs for 3 years or 36,000 miles, whichever comes first. Coverage area varies by retailer. Charges and fees may apply. Applies to original owner/lessee only.";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Templates[0].Logo_Color = "WHITE";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Templates[0].Copy_Color = "#ffffff";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Templates[0].Secondary_CTA_Text_Color = "#ff0000";
    ...
    banner.prototype.getDynamicData = function() {
        ...
        this.copy2 = this.dynamicModule._data.hyundai_master_feed_T2_Retargeting_Master[0].Video_Overlay_Text;
    ...
    banner.prototype.addListeners = function() {
        ...
        slideshow.addEventListener("click", this.onBannerClick.bind(this));
    };
    ...
    banner.prototype.exit = function(backup) {
        ...
        if (temple.isMobile) {
            if (!this.isEmpty(this.exitURLMobile.Url)) {
                ...
                Enabler.exitOverride("Backup Exit", this.backupURL);
            }
        } else {
    ...
    banner.prototype.populateElements = function() {
        ...
        copyContainer2.innerHTML = this.copy2;
        !this.isEmpty(this.ctaLearnCopy) ? ctaLearnCopy.innerHTML = this.ctaLearnCopy : $(".ctaLearn").hide();
