...
temple.Banner = function(_super) {
    ...
    banner.prototype.setupDynamic = function() {
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Asset.Progressive_Url = "https://gcdn.2mdn.net/videoplayback/id/5e3cb9f7b05b8c8e/itag/15/source/doubleclick/ratebypass/yes/mime/video%2Fmp4/acao/yes/ip/0.0.0.0/ipbits/0/expire/3648477073/sparams/id,itag,source,ratebypass,mime,acao,ip,ipbits,expire/signature/59D49CA233FA85852C93FDD91B4876E844BEC6C9.B39E2CC126A95A922F098D126FA177BAD69F344A/key/ck2/file/file.mp4";
		//this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Asset.Progressive_Url = "2017_ELA_black_friday_clip_160x320.mp4";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Endframe_Image.Url = "https://s0.2mdn.net/creatives/assets/2262973/Hero-Still_160x319-MY18-ElantraGT.jpg";
		//this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Endframe_Image.Url = "160x319_Elantra.jpg";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_1.Url = "https://s0.2mdn.net/creatives/assets/2235576/160x600_sonata_1.jpg";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_2.Url = "https://s0.2mdn.net/creatives/assets/2235576/160x600_sonata_2.jpg";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_3.Url = "https://s0.2mdn.net/creatives/assets/2235576/160x600_sonata_3.jpg";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_4.Url = "https://s0.2mdn.net/creatives/assets/2235576/160x600_sonata_4.jpg";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Multi_Image_Delay = "";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_Animation_Style = "SLIDE";
    ...
    banner.prototype.populateElements = function() {
        ...
        for (i = 0; i < this.endFrameCopyLines.length; i++) {
            ...
            if (i == 1 && this.template.toLowerCase() == "apr") {
                endFrameContainer.appendChild(divider);
            }
        }
        if (!this.video) {
            for (i = 0; i < this.slideshowImageSources.length; i++) {
        ...
        if (this.hasEndFrame) {
            if (this.template.toLowerCase() == "lease") {
    ...
    banner.prototype.applyStyling = function(colorScheme) {
        ...
        if (this.template.toLowerCase() != "apr") divider.hide();
