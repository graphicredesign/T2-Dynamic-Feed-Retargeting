...
temple.Banner = function(_super) {
    ...
    banner.prototype.init = function() {
        ...
        this.chain(temple.DynamicModule, {
            data: this.dynamicContent
        }).chain(this.getDynamicData).chain(this.setupBanner);
    };
    banner.prototype.setupDynamic = function() {
        Enabler.setProfileId(10018141);
        this.dynamicContent = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master = [ {} ];
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0]._id = 0;
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Template = "LEASE";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Asset_Type = "Image";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Asset = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Asset.Type = "video";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Asset.Progressive_Url = "https://gcdn.2mdn.net/videoplayback/id/e06fd730125e3477/itag/15/source/doubleclick/ratebypass/yes/mime/video%2Fmp4/acao/yes/ip/0.0.0.0/ipbits/0/expire/3648476967/sparams/id,itag,source,ratebypass,mime,acao,ip,ipbits,expire/signature/2259BF92147998301D479A0409C67A346DE153EB.9542A84C27886414AE03C4045DDC49AB9CBB9345/key/ck2/file/file.mp4";
//		this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Asset.Progressive_Url = "2017_ELA_black_friday_clip_300x374.mp4";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Asset.Stream_Url = "";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Endframe_Image = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Endframe_Image.Type = "file";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Endframe_Image.Url = "https://s0.2mdn.net/creatives/assets/2262973/Hero-Still_300x375-MY18-ElantraGT.jpg";
//		this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Endframe_Image.Url = "300x375_Elantra.jpg";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Video_Overlay_Text = "Optional features shown.";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_1 = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_1.Type = "file";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_1.Url = "https://s0.2mdn.net/creatives/assets/2235576/300x600_sonata_1.jpg";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_2 = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_2.Type = "file";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_2.Url = "https://s0.2mdn.net/creatives/assets/2235576/300x600_sonata_2.jpg";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_3 = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_3.Type = "file";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_3.Url = "https://s0.2mdn.net/creatives/assets/2235576/300x600_sonata_3.jpg";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_4 = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_4.Type = "file";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_4.Url = "https://s0.2mdn.net/creatives/assets/2235576/300x600_sonata_4.jpg";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_5 = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_5.Type = "file";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Image_Asset_5.Url = "";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Multi_Image_Delay = "2,2,2";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Optional_Award_Image = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Optional_Award_Image.Type = "file";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Optional_Award_Image.Url = "https://s0.2mdn.net/ads/richmedia/studio/20680911/20680911_20170803134047800_1x1.png";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Model = "Sonata";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Dealer_Locator_Model = "Hyundai-Sonata";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_1 = "Who says your daily commute<br>has to be mundane?";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_2 = "Stunning exterior design.";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_3 = "A driver’s seat that’s more like a sanctuary.";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_4 = "Check out our best Sonata ever.";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_Animation_Style = "FADE";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Copy_Layered = false;
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Multi_Copy_Delay = "";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Offer_Copy_1 = "Lease starting at";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Offer_Copy_2 = "179";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Offer_Copy_3 = "per mo.";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Offer_Copy_4 = "for 36 months with $1,999 due at lease signing. $0 security deposit. Excludes tax, title and license.";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Endframe_Animation_Style = "SLIDE";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].CTA_Button_At_Start_Toggle = true;
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].CTA_Left_Text = "find yours";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].CTA_Right_Text = "learn more";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Legal_Button_Text = "legal";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Legal_Container_Text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Exit_URL = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Exit_URL.Url = "https://www.hyundaiusa.com/sonata/index.aspx";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Exit_URL_Mobile = {};
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Master[0].Exit_URL_Mobile.Url = "https://www.hyundaiusa.com/sonata/index.aspx";
        ...
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Templates[0].Primary_CTA_Hover_Color = "#40A5BD";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Templates[0].Primary_CTA_Text_Color = "#FFFFFF";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Templates[0].Secondary_CTA_Bg_Color = "#000000";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Templates[0].Secondary_CTA_Hover_Color = "#999999";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Templates[0].Secondary_CTA_Text_Color = "#000000";
        this.dynamicContent.hyundai_master_feed_T2_Retargeting_Templates[0].Legal_Button_Text_Color = "#666666";
...
//		brandBorders = "no";
                ...
                if (i == 0) {
                    ...
                    if (!this.layeredCopy) {
                        ...
                        this.copyTimeline.add(TweenMax.to(copyElements[i], fade, {
                            x: 0,
                            opacity: 1,
                            delay: this.copyDelays[i - 1] - fade,
                            ease: Quad.easeInOut
                        }));
                    }
                }
    ...
    banner.prototype.findDealer = function(data) {
        ...
        if (data.GetDealerLocationNewJSONResult[0] === undefined) {
            ...
            var dl_cta = "img/visit_website_cta.png";
            var dl_border = "img/border.png";
...
//			this.getUserZip = "30032"; //test zip
			this.initial = false;
